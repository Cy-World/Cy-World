...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <head>
        ...
        <body class="grey lighten-4">
            ...
            <div class="contents">
                <!-- Input forms -->
                <form action="RegisterServlet" class="z-depth-3 cardLayout" method="post">
                    <h4 class="titleLayout">Registar</h4>
                    <div class="inputFormLayout">
                        <!--User Name  -->
                        <div class="input-field col s12">
                            <input class="validate" id="name" name="username" type="text"/>
                        ...
                        <!-- RePasswd -->
                        <div class="input-field col s12">
                            <input class="validate" id="repasswd" name="repasswd" type="password"/>
                            <label for="repasswd">Conpirm your Password</label>
                        </div>
                    </div>
                    <button class="waves-effect waves-light btn-large buttonLayout" name="action" type="submit">Create
