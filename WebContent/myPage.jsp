      ...
      <div class="col s8">
        <div class="roomContainer">
          <table class="bordered highlight avatar">
            ...
            <tr>
              <td>
                <a href="#"><i class="material-icons tiny">library_books</i> Room1</a>
              </td>
            </tr>
            <tr>
              <td>
                <a href="#"><i class="material-icons tiny">library_books</i> Room2</a>
              </td>
            </tr>
            <tr>
              <td>
                <a href="#"><i class="material-icons tiny">library_books</i> Room3</a>
              </td>
            </tr>
            <tr>
              <td>
                <a href="#"><i class="material-icons tiny">library_books</i> Room4</a>
              </td>
            </tr>
          </table>
        </div>
