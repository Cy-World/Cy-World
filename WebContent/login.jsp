...
<body class="grey lighten-4">
	...
	<div class="contents">
		...
		<form action="LoginServlet" class="z-depth-3 cardLayout" method="post">
			...
			%>
			<span class="blue-text text-darken-2 center-align"> Login
				incorrect</span>
			<%
				}
			%>
			...
			<div class="inputFormLaytout">
				<div class="input-field ">
					<input class="validate" id="mail" name="address" type="email"
						value="x13g111@chiba-fjb.ac.jp" /> <label for="mail">Email Address</label>
				</div>
				<!-- Password -->
				<div class="input-field">
					<input class="validate" id="passwd" name="passwd" type="password"
						value="x13g111" /> <label for="passwd">Password</label>
				</div>
			</div>
			<button class="waves-effect waves-light btn-large buttonLayout"
				name="action" type="submit">
				Login <i class="material-icons left">room</i>
			</button>
		</form>
	</div>
