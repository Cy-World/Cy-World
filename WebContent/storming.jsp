...
<body class="grey lighten-4">
	...
	<script charset="UTF-8" src="js/cyworldjs/storming.js"
		type="text/javascript"></script>
	...
	<div class="z-depth-3 cardLayout" id="card-input">
		<div class="row">
			<div class="inputFormLaytout">
				<input class="input-field col s12" class="validate" id="input-val"
					name="idea" placeholder="please input your idea" type="text"
					required="required" />
				<button class="btn waves-effect waves-light s4 offset-2 cardadd"
	...
	<div class="content-body">
		<div class="row">
			<div class="col s1">
				<a
					class="btn-floating btn-large waves-effect waves-light red cardadd">
			...
			<div class="modal-content">
				...
				<%
					...
					if (joinUserList != null)
						for (User joinUser : joinUserList) {
				...
				<div class="row">
					...
					<div class="col l4 offset-l2 s12">
						...
						<ul class="">
							...
							<li><a class="waves-effect waves-light btn"
								style="margin: 5px" href="https://github.com/Cy-World"> <i
