            ...
            <body class="grey lighten-4">
                ...
                <div class="contents row">
                    ...
                    <p>Footers are a great way to organize a lot of site navigation and information at the end of a page. This is where the user will look once hes finished scrolling through the current page or is looking for additional information about your website.
                        Introduction Note: We use flexbox to structure our html so that the footer is always on the bottom of the page. It is important to keep the structure of your page within the 3 HTML5 tags: Footer Content You can use rows and columns here to organize
                        your footer content.</p>
                    <h2>Let's Brain Storming!!</h2>
                    <a class="col m3 waves-effect waves-light btn-large topButton z-depth-2" href="#">
                        <i class="material-icons left">cloud</i>Global Room</a>
                    <a class="col m3 waves-effect waves-light btn-large topButton z-depth-2" href="createRoom.jsp">
                        <i class="material-icons left">settings</i>Create Room</a>
                    <a class="col m3 waves-effect waves-light btn-large topButton z-depth-2" href="storming.jsp">
                        <i class="material-icons left">input</i>Entering Room</a>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col l4 offset-l2 s12">
                                ...
                                <ul class="">
                                    <li>
                                        <a class="waves-effect waves-light btn footerButton" href="https://twitter.com/Cy_World2015?lang=ja">
                                            <i class="material-icons left">input</i>Twitter</a>
                                    </li>
                                    <li>
                                        <a class="waves-effect waves-light btn footerButton">
