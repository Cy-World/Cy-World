            ...
            <div class="contents">
                ...
                <form action="EditServlet" class="z-depth-3 cardLayout" method="post">
                    ...
                    <div class="inputFormLayout">
                        <img class="avatar" height="230" src="img/profilePool/<%=user.getImgPath()%>" width="230"/>
                        <!--User Name  -->
                        <div class="input-field col s12">
                            <input class="validate" id="name" name="username" type="text" value="<%=user.getName()%>"/>
                            <label for="name">UserName</label>
                        </div>
                        <!-- Email addless -->
                        <div class="input-field col s12">
                            <input class="validate" name="email" type="email" id="email"value="<%=user.getAddress()%>"/>
                            <label for="email">Email Address</label>
                        </div>
                        <!-- Passwd -->
                        <div class="input-field col s12">
                            <input class="validate" name="passwd" type="password" id="passwd"/>
                            <label for="passwd">Password</label>
                        </div>
                        <!-- RePasswd -->
                        <div class="input-field col s12">
                            <input class="validate" name="repasswd" type="password" id="repasswd"/>
                            <label for="repasswd">Conpirm your Password</label>
                        </div>
                    </div>
                    <button class="waves-effect waves-light btn-large buttonLayout" name="action" type="submit"/>
                    Create
